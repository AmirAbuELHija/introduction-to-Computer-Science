public class BankAccount {
	...
	/**
	 * toString method of the following format: "Name: "+name+", AccountNumber:
	 * "+accountNumber.
	 *
	 ...
	 * @return true if amount >= 0 else if amount is negative return false without
	 ...
	 * @return true if amount >= 0 and by decreasing balance it doesn't turns
	 *         negative, else if amount is negative or if balance < 0 after the
	 *         withdraw return false without changing the balance.
	 */
